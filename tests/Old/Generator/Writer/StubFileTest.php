...
namespace GraphQLGen\Tests\Old\Generator\Writer;
...
class StubFileTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$content = file_get_contents(getcwd() . '/tests/Old/Mocks/Stubs/StubFileTest.stub');
	...
	public function test_GivenStubFile_getContent_WillReturnCorrectFileData() {
		...
		$this->assertEquals(file_get_contents(getcwd() . '/tests/Old/Mocks/Stubs/StubFileTest.stub'), $retVal);
	}
